...
@section('content')
    <div class="card mb-4">
        ...
        <form class="card-body needs-validation" action="{{ route('employees.update', $employee->id) }}" method="POST"
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control flatpickr-input" placeholder="YYYY-MM-DD"
                        name="joining_date" readonly="readonly" value="{{ $employee->joining_date }}">
                    <div class="valid-feedback">Looks good!</div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Company Name" name="company_name"
                        value="{{ $employee->experience->company_name }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Designation" name="pre_designation"
                        value="{{ $employee->experience->designation }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control flatpickr-input" placeholder="YYYY-MM-DD" name="from_date"
                        readonly="readonly" value="{{ $employee->experience->from_date }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control flatpickr-input" placeholder="YYYY-MM-DD" name="to_date"
                        readonly="readonly" value="{{ $employee->experience->to_date }}" required>
                    <div class="valid-feedback">Looks good!</div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Degree" name="degree"
                        value="{{ $employee->education->degree }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Institute" name="university"
                        value="{{ $employee->education->university }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Year of Passing" name="year_of_passing"
                        value="{{ $employee->education->year_of_passing }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Grade" name="grade"
                        value="{{ $employee->education->grade }}" required>
                    <div class="valid-feedback">Looks good!</div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Name" name="family_name"
                        value="{{ $employee->family->name }}" required>
                    <div class="valid-feedback">Looks good!</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Relation" name="relation"
                        value="{{ $employee->family->relation }}" required>
                    <div class="valid-feedback">Looks good!</div>
